<template>
  <div>
    <section class="relative py-20 2xl:py-40 bg-gray-800 overflow-hidden h-screen">
      <img
        class="absolute top-0 right-0 md:-mr-96 md:-mt-112"
        src="zospace-assets/lines/circle.svg"
        alt=""
      />
      <img
        class="absolute top-0 right-0 h-40 lg:h-80 lg:mr-64 lg:mt-24"
        src="zospace-assets/images/five-stars.svg"
        alt=""
      />
      <img
        class="hidden lg:block absolute top-0 left-0 h-64 -ml-10"
        src="zospace-assets/images/blue-double-circle.svg"
        alt=""
      />
      <img
      ...
      <div class="relative container px-4 mx-auto">
        <div class="max-w-3xl mx-auto">
          <div class="max-w-xl">
            ...
            <h2 class="mt-12 mb-14 text-5xl font-bold font-heading text-white">
